   ...
   for (unsigned index_a = 0; index_a < All.size(); index_a++) {
      ...
      for (unsigned index_b = index_a; index_b < All.size(); index_b++) {
         ...
         if (All[index_a].FirstChrName == All[index_b].FirstChrName && All[index_a].SecondChrName == All[index_b].SecondChrName) {
            if (abs(static_cast<int>(All[index_a].FirstPos) - static_cast<int>(All[index_b].FirstPos)) < 10 
                && abs(static_cast<int>(All[index_a].SecondPos) - static_cast<int>(All[index_b].SecondPos)) < 10 && All[index_a].NumSupport + All[index_b].NumSupport >= cutoff) {
